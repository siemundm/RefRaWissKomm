...
## TikTok Minimalbeispiel
tiktokmin <- data.frame(Impulse_geben=c(6, 0, 4),
...
## png(file="03_tiktokmin.png", width = 900, height = 900)

## Chart als EPS speichern (Achtung, ohne Flächenfüllung)
## postscript(file="03_tiktokmin.eps", width = 900, height = 900)

radarchart(tiktokmin,
           axistype=4, 
           seg=6,
           pcol='navy',
           pfcol=rgb(0,0,1,0.3),
           ...
           axislabcol='black',
           cglwd=0.6,
           title='TikTok: Minimalistisches Beispiel',
           vlabels=c('Impulse \n geben', 
                     'Mit \n emotionalen \n Herausforderungen \n umgehen',
                     'Wissenschaft \n öffnen',
                     'Ton \n treffen',
