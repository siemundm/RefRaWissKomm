...
## Twitch Minimalbeispiel
twitchmin <- data.frame(Impulse_geben=c(6, 0, 4),
                        ...
                        Einheit_produzieren=c(6, 0, 5),
                        Plattform_nutzen=c(6, 0, 3))

## Chart als PNG speichern
## png(file="01_twitchmin.png", width = 900, height = 900)

## Chart als EPS speichern (Achtung, ohne Flächenfüllung)
## postscript(file="01_twitchmin.eps", width = 900, height = 900)

radarchart(twitchmin,
           axistype=4, 
           seg=6,
           pcol='navy',
           pfcol=rgb(0,0,1,0.3),
           ...
           axislabcol='black',
           cglwd=0.6,
           title='Twitch: Minimalistisches Beispiel',
           vlabels=c('Impulse \n geben', 
                     'Mit \n emotionalen \n Herausforderungen \n umgehen',
                     'Wissenschaft \n öffnen',
                     'Ton \n treffen',
